...
With **OeMga α (oemga_alpha)** as the foundational product, this repo will grow to support additional OEMGA modules and hardware revisions over time.
...
```bash
mkdir oemga-workspace && cd oemga-workspace
git clone https://github.com/OeMga-me/oemga-core.git
cd oemga-core
./oemga setup
```
Note: This one-time setup takes 15–25 minutes, but makes all future builds near-instant. 
